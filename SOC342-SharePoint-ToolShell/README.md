...
My local antivirus actually blocked me from running the decode in PowerShell — which is a good sign, means the payload is genuinely flagged as malicious by AV.
